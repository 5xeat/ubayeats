...
document.addEventListener('turbolinks:load', () => {
  if (document.querySelector('.driver_profiles.index')){
    ...
    const loader = new Loader({
      apiKey: "AIzaSyBL-80hWXX74wWTTTjPIc3uNz_uUH5Wd-w",
      version: "beta",
      libraries: ["places"],
      mapIds: ["c57b36ae7dbc5a40"]
    });
    ...
    loader
      ...
      .then(() => {
        console.log('loader');
        let map, marker, lat, lng, place, directionMarkers, endMarker, leg, request;
        directionMarkers =[];
          ...
          directionsService.route(request, function (result, status) {
            if (status == 'OK') {
              ...
              if (googleBtn){
                ...
                document.querySelector('#map').insertAdjacentElement('beforebegin', stepsList)
                ...
                document.querySelector('.main').appendChild(googleBtn)
              }
